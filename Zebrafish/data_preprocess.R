...
saveRDS(colnames(x_infected), "gen_names.rds")
rownames(x_not_infected)=NULL
colnames(x_not_infected)=NULL
rownames(x_infected)=NULL
colnames(x_infected)=NULL
saveRDS(as.matrix(x_infected), "infected_genus_level.rds")
saveRDS(as.matrix(x_not_infected), "not_infected_genus_level.rds")